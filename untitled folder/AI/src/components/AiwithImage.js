...
const AiwithImage = () => {
    const genAI = new GoogleGenerativeAI('AIzaSyAz6lyQmy_GCN9SBgQIyMP7fqXZiC47gT8');
    ...
    async function aiImageRun() {
        ...
        const result = await model.generateContent([
            "This is a geographical location in srilanka ", imageInineData,"tell me details about this place pointwise"
        ]);
